...
class gruposController extends Controller
{
	...
	const edit='<a href="#editGrupoModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a><a href="#deleteGrupoModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>';
    
    public function index(){
    	$grupos=[
			0=>array("Coronel Rosales","234","25/10/1986","14:00","17:00","","Religión Heterogenea",
						self::ubicacion,self::ramas,self::edit),
